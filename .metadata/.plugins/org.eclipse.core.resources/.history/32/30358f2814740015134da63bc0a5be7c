...
****************
<jsp:useBean id="u" class="pk.SimplePojoModel"  scope="request" >this  is  use  bean</jsp:useBean>
...
String k=u.getSchoolname();
k.length();
out.println("<h1> t is  --" + t +"fyhhjk--" +  k +  "length  is" + k.length()  + "</h1>");
%></h1>  
<h1>above  property</h1>
String k1=u.getSchoolname();
<h1>k1</h1>
