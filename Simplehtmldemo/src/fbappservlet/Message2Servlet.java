	    ...
	    //  String  mesg=request.getParameter("mesg");
   	   ...
   	   ResultSet   rs2=smt1.executeQuery("select  *  from  message1");
        	   while(rs2.next())
   	     {
   	  	  ...
   	  	  //   mesg=rs2.getString(2);	
   	  	   PrintWriter  out=response.getWriter();
   	     	System.out.println("your  message  shoild  display  in  textara");
   	   //  out.println("<FORM >");
   	  //out.println("<input type='text'name='owner'value="+ rs2.getString(2) +">");
   	//  System.out.println("The value of the entered field is" + rs2.getString(2));
   	 //  out.println("</form>");
   	  out.println("<html>");
   	  out.println("<body>");
   	  out.println("<br/>");
   	out.println("<br/>");
   	  out.println("<textarea >" +  " message  " + rs2.getString(2) + "</textarea>");
   	out.println("<br/>");
   	out.println("<br/>");
   	  out.println("</body>");
   	   out.println("</html>");
